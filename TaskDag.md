...
CREATE TASK IF NOT EXISTS GENERAL_HOSPITAL_PATIENTS.ADMIN_HEALTHCARE_PATIENT_DATA_INGEST_START
    WITH TAG (
        DATA_GOVERNANCE.COSTING_TAGS.ENVIRONMENT = 'DEVELOPMENT',
...
AS
    CREATE OR REPLACE TEMPORARY TABLE GENERAL_HOSPITAL_PATIENTS.ADMIN_HEALTHCARE_PATIENT_DATA_INGEST_TRIGGER_RESET AS
        SELECT *
        FROM GENERAL_HOSPITAL_PATIENTS.INBOUND_HEALTHCARE_FILES_STREAM;
